...
- EODHD-Aufrufe laufen durch eine zentrale Backend-Drosselung.
- Das Tool zählt Calls pro Tag im laufenden Backend-Prozess.
- Temporäre EODHD-Fehler wie 429/5xx werden mit begrenzten Retries erneut versucht.
- Tageslimit, Call-Abstand und Retry-Anzahl sind über `.env` konfigurierbar.
